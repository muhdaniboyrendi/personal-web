...
<template>
  <form @submit.prevent="handleSubmit" ref="contactForm" class="w-full p-5 rounded-2xl border border-slate-700">
    ...
    <button type="submit" class="w-full py-2 px-5 rounded-xl text-sky-500 border-2 border-sky-500 transition hover:bg-sky-500 hover:text-white dark:hover:text-white hover:shadow-md hover:shadow-sky-500" :class="{ 'hidden': isLoading }">Send</button>

    <button type="submit" class="w-full py-2 px-5 rounded-xl text-sky-500 border-2 border-sky-500 transition hover:bg-sky-500 hover:text-white dark:hover:text-white hover:shadow-md hover:shadow-sky-500" :class="{ 'hidden': !isLoading }">
