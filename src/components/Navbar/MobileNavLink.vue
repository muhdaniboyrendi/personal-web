...
<template>
  ...
  >
    ...
    <RouterLink
      to="/equipments"
      class="w-1/3 flex flex-wrap justify-center mt-1"
    >
      <div
        class="flex justify-center items-center w-10 h-10 rounded-full bg-opacity-20"
    ...
    <RouterLink to="/contact" class="w-1/3 flex flex-wrap justify-center mt-1">
      <div
        class="flex justify-center items-center w-10 h-10 rounded-full bg-opacity-20"
  ...
  >
    <div class="flex items-center">
      <div
        class="flex justify-center items-center w-10 h-10 mr-2 rounded-full bg-gray-800 bg-opacity-20 dark:bg-sky-500 dark:bg-opacity-80"
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="20"
