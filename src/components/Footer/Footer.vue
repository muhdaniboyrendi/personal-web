<template>
  <footer class="px-4 py-6 mt-10 md:py-8">
    <span class="w-full max-w-4xl mx-auto mb-5 block border-b border-border_dark"></span>
    <div class="flex flex-wrap justify-start md:justify-center mb-4">
