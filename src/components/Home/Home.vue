  ...
  <section>
    <div class="flex flex-wrap pb-40 pt-20 px-4 mx-auto max-w-screen-xl lg:py-28">
      ...
      <div class="lg:w-1/2 pt-20">
        ...
        <p class="mb-8 ml-1 text-lg font-normal text-gray-500 lg:text-xl dark:text-gray-400">Web Developer</p>
      </div>

      <div class="w-full lg:w-1/2 flex justify-center">
        <div class="relative bg-slate-200 mt-10 lg:mt-0 lg:right-0 rounded-full shadow-lg shadow-sky-500 border-2 border-sky-500 overflow-hidden">
